...
class ImageEditor extends StatelessWidget {
  ...
  final o.AdjustOPtion? adjustOption;
  ...
  const ImageEditor({
    ...
    this.adjustOption = const o.AdjustOPtion(),
  });
...
/// Image editor with all option available  1
                  ...
                  if (widget.adjustOPtion != null)
                    BottomButton(
                      ...
                      onTap: () async {
                        ...
                        Uint8List? AdjustImage = await Navigator.push(
                          context,
                          MaterialPageRoute(
                        ...
                        if (AdjustImage == null) return;

                        flipValue = 0;
                        rotateValue = 0;

                        await currentImage.load(AdjustImage);
                        setState(() {});
                      },
                    ),
                ],
...
class AdjustScreen extends StatefulWidget {
  final Uint8List image;
  const AdjustScreen({super.key, required this.image});
